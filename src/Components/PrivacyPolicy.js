    ...
    return(
        <div className="container-fluid">
            ...
            <div className="col-md-11">
                ...
                <ul>
                <li>Contact information (e.g. name, email address, postal address)</li>
                <li>Payment information (e.g. credit card number, billing address)</li>
                <li>Demographic information (e.g. age, gender)</li>
                <li>Usage data (e.g. courses taken, progress, preferences)</li>
                </ul></p>

                <p><b>Data Usage</b><br></br>
                The personal data collected is used for the following purposes:<br></br>
                <ul>
                <li>To provide and improve our services</li>
                <li>To process payments and handle billing</li>
                <li>To communicate with users regarding their account and courses</li>
                <li>To personalize user experience and recommend courses</li>
                <li>To comply with legal obligations</li>
                </ul>
                </p>

                <p><b>Data Sharing</b><br></br>
                ...
                We implement reasonable technical, administrative, and physical security measures to protect personal data from unauthorized access, alteration, disclosure, or destruction. However, no online platform can guarantee the security of user data, and users provide their personal data at their own risk.</p>
